...
export default function GuestBook() {
    ...
    const handleSelectCustomer = (customer) => {
        // Use the selected customer data but inject current sticky branch?
        // User: "tambah customer... menggunakan logika yg sama... misal data sudah ada tinggal panggil"
        // Strategy: Use existing data, but confirm/select Branch.
                    ...
                    {!showManual ? (
                        ...
                        <div className="manual-form" style={{ padding: 20, background: '#f9f9f9', borderRadius: 12 }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 15 }}>
                                <h3 style={{ margin: 0 }}>Input Manual</h3>
                                <button onClick={() => setShowManual(false)} style={{ background: 'none', border: 'none', fontSize: 20, cursor: 'pointer' }}>✖</button>
                            </div>
